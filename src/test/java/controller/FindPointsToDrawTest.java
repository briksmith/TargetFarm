...
public class FindPointsToDrawTest
{
	...
	private void setMockingBehavior()
	{
		...
		when(farm.getRowCount()).thenReturn(X);
	...
	{
		return new Object[]{
				 new Object[] { new Point(6, 4), new Point(6, 7) }, 
					new Object[] { new Point(17, 17), new Point(17, 19) },
				 new Object[] { new Point(4, 13), new Point(4, 15)},
				 new Object[] { new Point(4,9), new Point(4, 12) },
				 new Object[] { new Point(18,6), new Point(18, 8) },
				 new Object[] { new Point(7, 15), new Point(7, X)},
				 new Object[] { new Point(6,7), new Point(7, 9) }};
				 }
